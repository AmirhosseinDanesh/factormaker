                ...
                {({ isSubmitting, values }) => (
                    <div className="mt-5 text-sm md:text-lg">
                        <Form className="mt-5 space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-200 border-blue-500 rounded-3xl border-r-4 p-8">
                                        ...
                                        <>
                                            {Array.isArray(values.infos) &&
                                                values.infos.map((_, index) => (
                                                    <div key={index} className="grid grid-cols-2 gap-4 pb-4 border-b border-gray-900">
                                                        <Field
                                                            as={Input}
                                                            label="نام خدمات"
                                                            type="text"
                                                        ...
                                                        <Field
                                                            ...
                                                            placeholder=""
                                                        />
                                                        <span className='flex justify-center col-span-2' onClick={() => { remove(index) }}>
                                            ...
                                            <span className="flex items-center justify-center" onClick={() => push({ infoName: '', infoPrice: '' })}>
                                                <svg
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-green-200 px-6 py-2 pb-4 mb-4 rounded-2xl">
